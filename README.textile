...
This *spring-security-oauth-client-demo* project is a demo webapp to test the "spring-security-oauth-client library":https://github.com/leleuj/spring-security-oauth-client *version >= 1.1.0* with Facebook and Twitter.
